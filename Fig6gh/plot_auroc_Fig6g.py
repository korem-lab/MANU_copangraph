...
def find_pickle_filename(feature):
    if feature == 'copan':
        filename = "/insomnia001/depts/pmg/users/ic2465/Projects/MANU_copangraph/data/Fig6gh/crc/copan.prediction.pkl"
    elif feature == 'mOTUs':
        filename = "/insomnia001/depts/pmg/users/ic2465/Projects/MANU_copangraph/data/Fig6gh/crc/mOTUs.prediction.pkl"
    elif feature == 'humann':
        filename = "/insomnia001/depts/pmg/users/ic2465/Projects/MANU_copangraph/data/Fig6gh/crc/humann.prediction.pkl"
    else:
...
def main():
    ...
    if CLEAN_FIG:
        TARGET_FILENAME = f"../data/Fig6gh/Fig6g_UNLBL.pdf"
    else:
        TARGET_FILENAME = f"../data/Fig6gh/Fig6g_LBL.pdf"
    ...
    if not CLEAN_FIG:
        plt.title(f"CRC Prediction task")
