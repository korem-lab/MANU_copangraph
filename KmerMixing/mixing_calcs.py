...
GENOMES = '/burg/pmg/users/ic2465/Projects/MANU_copangraph/data/GherigGraphQuality/MAG_results/9_sample_reference.fasta'
...
if __name__ == '__main__':
    ...
    mgs_record.to_csv(os.path.join(OUTDIR, f'{tool}_{param}_multisample_record.csv'), index=False)
