...
DATA = '../data/KmerMixing/coasm_50_rep_0_'
if __name__ == '__main__':
    ...
    copan_1000_1 = pd.read_csv(DATA + 'copan_ms_1000_dt_1_kmix.csv')
    ...
    copan_1000_1 = copan_1000_1.loc[copan_1000_1.sample_count > 1, :]
    ...
    copan_1000_1_prop = (copan_1000_1.node_count < copan_1000_1.sample_count).sum() / len(copan_1000_1.node_count)
    ...
    print('copan_1000_1: ', copan_1000_1_prop)
