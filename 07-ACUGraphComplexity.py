...
DATA = '/manitou/pmg/projects/korem_lab/Projects/MANU_copangraph/ACUGraphComplexity/'
...
if __name__ == '__main__':
    ...
    for m in ['nodes', 'edges', 'N50', 'N90']:
        ...
        sns.lineplot(x=m_df.n_samples, y=m_df.value, hue=m_df.dt, palette='flare', errorbar='sd')
        plt.tight_layout()
        ...
        plt.savefig(os.path.join(DATA, f'{m}_complexity_dt_labels.pdf'), dpi=1400, bbox_inches='tight')
        frame1 = plt.gca()
        ...
        plt.ylabel('')
        plt.tight_layout()
        plt.savefig(os.path.join(DATA, f'{m}_complexity_dt_nolabels.pdf'), dpi=1400)
