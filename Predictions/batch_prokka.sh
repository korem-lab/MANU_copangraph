...
#SBATCH --account pmg
#SBATCH --output=/burg/pmg/users/ic2465/Projects/MANU_copangraph/data/Predictions/moms-pi/prokka-%x-%j.log
OUTDIR=/burg/pmg/users/ic2465/Projects/MANU_copangraph/data/Predictions/moms-pi/prokka
