...
def get_X(labels, organism_specific):
    ...
    humann_df_loc = '/manitou/pmg/projects/korem_lab/Projects/CRC_COPAN_PREDICTION/HMN/humann_CRC_CN_genefamilies_filtered_MLready.csv'
...
def main(output_dir, task_name, labels, robust, run_params, model_params, dry_run, iterations=250, ofld=10, ifld=5):
    ...
    X = get_X(labels=labels, organism_specific=ORGANISM_SPECIFIC)
