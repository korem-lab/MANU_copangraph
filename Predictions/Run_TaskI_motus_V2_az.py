...
def get_X(labels):
    ...
    # Read in mOTUs table
    motus_df_loc = '/manitou/pmg/projects/korem_lab/Projects/ACU_PLT/mmmbp2/df_path2/mOTUs2.df'
    print(f"Reading mOTUs table from {motus_df_loc}")
    X = pd.read_pickle(motus_df_loc)
...
def main(output_dir, task_name, labels, robust, run_params, model_params, dry_run, iterations=250, ofld=10, ifld=5):
    ...
    pred.run(
        ...
        hours = 29,
        cpus=2,
        out_file=f'{output_dir}/motus.{task_name}.prediction_1000its.pkl',
        save_features=False,
        ...
        #path_to_qp_recover='/burg/pmg/users/ic2465/Projects/MANU_copangraph/Predictions/motus.TaskI_mts_p3_runner__d05ca9488c514b68ab177db0391e1349'
    )
    pred.notes = """
    """
