...
def get_X(labels):
    ...
    # Read in mOTUs table
    X = pd.read_csv("/manitou/pmg/projects/korem_lab/Projects/MOMSPI_COPAN_PREDICTION/MTS/mOTUs_MOMS_PI_RA.csv", index_col=0)
